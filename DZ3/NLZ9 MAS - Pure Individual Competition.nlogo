...
to setup
  ...
  create-rovers 2 [
    ...
    set shape "rover"
    set color blue
    ;; Set position and heading for each rover
    if (who = 0) [
      setxy -8 -6
      set heading 90
    ]
  ...
  create-cars 2 [
    set color yellow
    set shape "car"
    ;; Set position and heading for each car
    if (who = 2) [
      setxy 8 6
      set heading 270
    ]
  ...
  ask n-of 3 patches [ set pcolor orange ]
...
to go
  ...
  [
    ...
    [ show "Cars win" ]
    stop ]
  ask rover 0 [ walk1 ]            ;; pokrece se funkcija walk1 za prvi rover
  ask rover 1 [ walk1 ]
  ask car 2 [ walk2 ]            ;; pokrece se funkcija walk2 za drugi rover
  ask car 3 [ walk2 ]
  tick
end
