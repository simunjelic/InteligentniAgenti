  ...
  [
    ...
    [
      show "Success!"       ;; ukoliko je manje od 10% neispravnih serija je uspjela
       set failCounter products + failCounter
       type products type "/" type failCounter print ""

      ask patch 6 6
        [
          set pcolor red     ;; signalno svjetlo se postavlja na zelenu boju
        ]
      stop
    ]
    if ticks mod 2 = 0 [
  ...
  [
    ...
    [
      ...
      set products products + 1
       type "Good product No. " type products print "" ; dodan ispis dobrih proizvoda
      ]
...
to new-product
  ...
  [
    set color one-of remove gray base-colors
      ...
      set new-products  new-products + 1                   ;; broji se zapoceti proizvod
